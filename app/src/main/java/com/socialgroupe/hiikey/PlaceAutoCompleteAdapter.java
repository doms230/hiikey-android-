...
/**
 * Created by Dominic on 3/27/2015.
...
implements Filterable{
     ...
     * Ensure that the client has successfully connected, contains the
...
// Release the buffer now that all data has been copied.
    ...
    class PlaceAutocomplete{
        ...
        public CharSequence descrip;

        PlaceAutocomplete(CharSequence placeId, CharSequence descrip){
