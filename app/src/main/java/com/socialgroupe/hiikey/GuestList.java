 ...
 */
@ParseClassName("List")
public class GuestList extends ParseObject {
...
//////////////////On this date////////////////////////////////////
    ...
    public static ParseQuery<GuestList> getList(){
        return ParseQuery.getQuery(GuestList.class);
    }
}
